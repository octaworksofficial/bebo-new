...
// Inject styles once on mount to avoid hydration issues
const injectStyles = (glowColor: string) => {
                ...
                >
                  ...
                  {card.backgroundImage && (
                    <>
                      ...
                      <div className="absolute inset-0 z-0 bg-gradient-to-t from-black/95 via-gray-900/60 to-transparent" />
                    </>
                  )}
                  {card.label && (
                    <div className="card__header relative mb-2 flex justify-between gap-3 text-white">
                      <span className="card__label text-sm opacity-70">{card.label}</span>
                      {card.icon && <span className="card__icon">{card.icon}</span>}
                    </div>
                  )}
                  {!card.label && card.icon && (
                    <div className="card__header relative mb-2 flex justify-end gap-3 text-white">
                      <span className="card__icon">{card.icon}</span>
                    </div>
                  )}
                  <div className="card__content relative z-10 flex flex-col text-white">
                    <h3 className="card__title m-0 mb-2 text-lg font-semibold">
                      {card.title}
                    </h3>
